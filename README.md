...
| Test                                                           | Expect                                                                      |
| -------------------------------------------------------------- | --------------------------------------------------------------------------- |
| It will store user input for movie choice, time of day and age | MovieTicket(movie, time, age).toEqual("new release", "matinee", "student"); |
| It will display movie ticket price based on user input         | MovieTicket(totalPrice).toEqual(\$100);                                     |
